...
// Prepay 下单后生成二维码地址，扫码支付
// https://pay.weixin.qq.com/doc/v3/merchant/4012791878
func (s *Service) Prepay(ctx context.Context, t weixinpay.PrepayRequest) (PrepayDTO, error) {
	...
	pr := native.PrepayRequest{
		...
		//Payer:     &h5.Payer{Openid: core.String(t.PayerOpenid)},
		Detail:    detail,
		SceneInfo: sceneInfo,
	...
	resp, _, err := client.Prepay(ctx, pr)
	if err != nil {
